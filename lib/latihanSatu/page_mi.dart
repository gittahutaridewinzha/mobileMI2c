      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text('Program Studi D3 Manajemen Informatika didirikan pada tahun 2005, '
                'dan terakreditasi dengan peringkat B berdasarkan Surat Keputusan Badan Akreditasi nasional '
                'Perguruan Tinggi (BAN-PT) Departemen Pendidikan dan kebudayaan republik Indonesia Surat Keputusan Nomor :'
