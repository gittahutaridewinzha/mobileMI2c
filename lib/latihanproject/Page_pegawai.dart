  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(
          Uri.parse("http://192.168.100.133/edukasi_server/getPegawai.php"));
                                    ...
                                    actions: [
                                      ...
                                      TextButton(
                                        onPressed: () {
                                          ...
                                          http.post(
                                            Uri.parse('http://192.168.100.133/edukasi_server/deletePegawai.php'),
                ...
                ElevatedButton(
                  onPressed: () {
                    if (keyForm.currentState?.validate() == true) {
                      ...
                      http.post(
                        Uri.parse('http://192.168.100.133/edukasi_server/updatePegawai.php'),
                        body: {
